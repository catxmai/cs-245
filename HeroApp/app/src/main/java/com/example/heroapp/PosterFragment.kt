...
class PosterFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (activity is MainActivity) {
            ...
            val day=mainActivity.hero.background
            val hero=mainActivity.hero.foreground
            hero_img.setBackgroundResource(
                when{
                    hero=="superman"->R.drawable.superman
                    hero=="batman"->R.drawable.batman
                    else->R.drawable.ironman
                }
            )
            background.setBackgroundResource(
                when{
                    day=="day"->R.drawable.day
